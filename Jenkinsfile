pipeline {
    ...
    environment {
        ...
        VPC_ID ="vpc-056bed8e80d1a2fb8"
        SUBNETS = "subnet-0406afa28b63965f1,subnet-0f47eade2f31b4e6f,subnet-0927b816ef9bc9334,subnet-041082b82472ee57b"
        SECURITYGROUPS = "sg-02e36facd97ad5ffc"
        MIN_CAPACITY = "1"
        MAX_CAPACITY = "3"
        lbArn = ""
        tgArn = ""
